...
#
# Space Complexity O(N). The depth of queue can grow upto N in
...
class Solution:
    def mergeTrees(self, root1: TreeNode, root2: TreeNode) -> TreeNode:
        ...
        queue = [(mer, root1, root2), ]
        while queue:
            r0, r1, r2 = queue.pop(0)
            if not r1 or not r2:
                continue
            ...
            if not r1.left:
                ...
                queue.append((r0.left, r1.left, r2.left))

            if not r1.right:
                r0.right = r2.right
            else:
                queue.append((r0.right, r1.right, r2.right))
        return mer
